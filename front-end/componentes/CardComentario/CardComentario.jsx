const CardComentario = () => {
    ...
    React.useEffect(async () => {
        const url = "http://projetos/Fullstack-Eletro-GIT-main/back-end/Models/Comentario/";
    ...
    function registroDeComentario(event) {
        ...
        const url = "http://projetos/Fullstack-Eletro-GIT-main/back-end/Models/Comentario/registro-comentario.php";
